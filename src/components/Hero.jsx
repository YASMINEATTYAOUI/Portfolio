          ...
          <div className="flex gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="social-link w-11 h-11 rounded-full bg-gray-800/50 border border-gray-700/50 flex items-center justify-center hover:bg-purple-500/20 hover:border-purple-400/50 transition-all duration-300 text-gray-400 hover:text-purple-300"
                title={social.name}
              >
                {social.icon}
              </a>
