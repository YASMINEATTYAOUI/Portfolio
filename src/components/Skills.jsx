      ...
      <section className="min-h-screen flex items-center justify-center px-6 py-20 bg-gradient-to-b from-black via-purple-900/20 to-black">
        <div className="max-w-6xl w-full">
          ...
          <div className="section-title flex items-center gap-4 mb-12">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white text-center whitespace-nowrap">
              Mes Compétences
            </h2>
            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-blue-500 to-transparent" />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16 max-w-5xl mx-auto">
            ...
            <div className="group bg-white/5 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8 shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 hover:scale-[1.02] hover:border-purple-400/50">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                  Designer
                </h3>
                <i className="bx bx-laptop text-5xl text-gray-400 group-hover:text-purple-400 transition-all duration-300 group-hover:scale-110"></i>
              </div>
            ...
            <div className="group bg-white/5 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8 shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 hover:scale-[1.02] hover:border-purple-400/50">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
                  Developer
                </h3>
                <i className="bx bx-code-block text-5xl text-gray-400 group-hover:text-blue-400 transition-all duration-300 group-hover:scale-110"></i>
              </div>
              <p className="text-gray-300 text-base leading-relaxed">
